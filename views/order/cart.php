...
<?php
    ...
    else
    {
        ...
        {
            echo("<a class=\"btn btn-s btn-success cart-order\" href=\"index.php?page=order&amp;step=address\">Address info</a>");
        }
        else
        {
            echo("<a class=\"btn btn-s btn-success cart-order\" href=\"index.php?page=login&amp;returnTo=order&step=address\">Login</a>");
        }
    }
